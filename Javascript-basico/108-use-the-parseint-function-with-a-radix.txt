...
La parseInt()función analiza una cadena y devuelve un número entero. Toma un segundo argumento para la raíz, que especifica la base del número en la cadena. La raíz puede ser un número entero entre 2 y 36.
