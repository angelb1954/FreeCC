...
JavaScript reconoce siete tipos de datos primitivos (inmutables): Boolean, Null, Undefined, Number, String( Symbolnuevo con ES6) y BigInt(nuevo con ES2020), y un tipo para elementos mutables: Object. Tenga en cuenta que en JavaScript, las matrices son técnicamente un tipo de objeto.

Agregue dos console.log()declaraciones para verificar typeofcada una de las dos variables seveny threeen el código.
